    ...
    private List<SecurityContext> securityContexts() {
        return new ArrayList<>(
                Collections.singleton(SecurityContext.builder()
                        ...
                        .forPaths(regex(securityPathRegex))
                        .build())
        );
    }
...
//                .paths(any())
//                .build()
////                .globalResponseMessage(HttpMethod.GET,
...
//                return DocumentationType.SWAGGER_2.equals(delimiter) || DocumentationType.SWAGGER_2.equals(delimiter);
//            }
//        };
//    }
//
...
//        return new ApiDescription("/api/auth/login", "Login method to get user JWT token data", "Login endpoint", Collections.singletonList(
